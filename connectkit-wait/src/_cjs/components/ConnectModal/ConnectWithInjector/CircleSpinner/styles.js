...
exports.Spinner = exports.ExpiringSpinner = exports.SpinnerContainer = exports.Logo = exports.LogoContainer = void 0;
...
exports.SpinnerContainer = (0, styled_1.default)(framer_motion_1.motion.div) `
  ...
  inset: -5px;
`;
exports.ExpiringSpinner = (0, styled_1.default)(framer_motion_1.motion.div) `
  pointer-events: none;
  user-select: none;
  z-index: 1;
  position: absolute;
